// objectTypeTables.js
// Тут будет храниться вся логика для работы с таблицами типов объектов
...
function createObjectTypeTables() {
    for (let i = 1; i <= 12; i++) {
        ...
        // if (container) {
        //   container.innerHTML = ''; // Очищаем контейнер, если он уже существует
        // }
        // else {
        ...
        objectTypeGrids[i] = new GridManager(containerId, gridOptions, () => Promise.resolve([]));
    }
}
